  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-start">
        <div className="max-w-2xl px-6 sm:px-8 lg:px-12 py-12">
          {/* Main heading */}
          <h1
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-10">
            <a
              href="mailto:hello@yachtversal.com"
              className="inline-flex items-center justify-center px-8 py-4 font-medium text-white transition-opacity hover:opacity-90 whitespace-nowrap rounded-2xl"
              style={{
            ...
            <a
              href="tel:+1-800-YACHT-VERSAL"
              className="inline-flex items-center justify-center px-8 py-4 font-medium transition-all whitespace-nowrap rounded-2xl border-2"
              style={{
