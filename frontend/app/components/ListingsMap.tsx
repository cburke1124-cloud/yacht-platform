          ...
          const infoWindow = new google.maps.InfoWindow({
            content: `
              <div style="min-width:160px;font-family:'Poppins',sans-serif;padding:4px">
                ...
                ${locationLine ? `<p style="color:rgba(16,33,79,0.5);font-size:11px;margin:0 0 6px">📍 ${locationLine}</p>` : ''}
                <a href="/listings/${listing.id}" style="display:inline-block;background:#01BBDC;color:#FFF;border-radius:6px;padding:4px 10px;font-size:12px;font-weight:600;text-decoration:none">View Listing →</a>
              </div>
            `,
          });
