...
interface BoatTypeInfoProps {
  boatType: BoatType;
}

export default function BoatTypeInfo({ boatType }: BoatTypeInfoProps) {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="prose prose-sm max-w-none text-gray-700 space-y-4 font-poppins">
              {boatType.longDescription.split('\n\n').map((para, idx) => (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F8F9FC] border border-gray-200 p-6">
              ...
              <ul className="space-y-3">
                {boatType.whatToExpect.map((item, idx) => (
