...
const ENV_VARS_LIST = [
  ...
  { key: 'CLAUDE_API_KEY', description: 'AI search (Claude)', required: false },
  { key: 'S3_BUCKET', description: 'R2 bucket name', required: true },
  { key: 'S3_ENDPOINT_URL', description: 'Cloudflare R2 endpoint URL', required: true },
  { key: 'S3_ACCESS_KEY_ID', description: 'R2 access key', required: true },
