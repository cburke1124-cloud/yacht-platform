...
import DealerProfileEditForm from '../DealerProfileEditForm';
...
export default function AdminDealersTab() {
  ...
  // Edit profile modal state — the form itself (fields, media upload) lives
  // in the shared DealerProfileEditForm component.
  ...
  // Profile fetch/save/media-upload logic now lives in the shared
  // DealerProfileEditForm component (fetches its own data from dealerId).
  const openEditProfile = (dealer: any) => {
    ...
    <div>
      ...
      {editingProfile && (
        <DealerProfileEditForm
          dealerId={editingProfile.dealerId}
          dealerName={editingProfile.dealerName}
          apiBase="/admin/dealers"
          showTrustToggles
          onSaved={() => {
