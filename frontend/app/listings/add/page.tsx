...
const options = [
  ...
  },
  {
    ...
    accentColor: '#059669',
    title: 'Bulk Import',
    subtitle: 'Add your entire inventory at once',
    desc: 'Paste the URL of your listings page and YachtVersal imports all your yachts in one shot — the fastest way to get started.',
