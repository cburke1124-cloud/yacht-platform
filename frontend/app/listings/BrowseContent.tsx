...
function BrowseContent({ initialListings = [], initialTotal = 0, hasInitialData = false }: BrowseContentProps) {
...
export default function BrowsePage(props: BrowseContentProps) {
