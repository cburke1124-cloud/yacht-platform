...
_DEFAULTS: dict[str, str] = {
    "full": (
        ...
        "5. For description: write a concise, factual summary of the vessel. Avoid flowery or "
        "over-elaborate language — yacht buyers prefer clear, professional descriptions."
    ),
    "partial": (
        ...
        "For description: write a concise, factual summary. Avoid flowery or over-elaborate language —\n"
        "yacht buyers prefer clear, professional descriptions.\n\n"
